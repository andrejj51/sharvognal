...
function decorateCommunity(route) {
  ...
  if(route[0]==='player'&&player(Number(route[1]))?.membership_status==='pending') app.insertAdjacentHTML('afterbegin','<div class="community-notice"><div><strong>Первый шаг к рейтингу</strong><p>После первой игры попросите организатора подтвердить результат. Пока профиль не участвует в общем рейтинге.</p></div></div>');
